...
num_student=csv_reader.line_num-1
average_sub1=sub1_sum/num_student
average_sub2=sub2_sum/num_student
average_sub3=sub3_sum/num_student
print("Total marks of all students:",total_mark)
...
print("Student with second highest mark:",second_highest_student[1], "with Roll no:",second_highest_student[0])
